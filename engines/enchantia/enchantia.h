...
// NOTE Only scenes which are directly referenced in the code are listed here.
    ...
    private:
        ...
        void insertSpriteList(const SpriteListItem *spriteList, uint count, uint16 spriteDefId, uint spriteIndex,
                              byte ticks);
    ...
    public:
        ...
        static kReadSaveHeaderError
        readSaveHeader(Common::SeekableReadStream *in, bool loadThumbnail, SaveHeader &header);

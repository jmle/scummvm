    ...
    void EnchantiaEngine::updateScene() {
        ...
        switch (_sceneIndex) {
            ...
            case kSceneCliff:
                ...
                if (_sprites[5].x - actorSprite().x >= 0 && _sprites[5].x - actorSprite().x <= 10 &&
                    _flgCanRunBoxClick) {
                ...
                if (_sprites[14].status) {
                    ...
                    } else if (_sprites[14].y - actorSprite().y >= 0 &&
                               _sprites[14].y - actorSprite().y <= actorSprite().height &&
                ...
                if (_sprites[22].status) {
                    ...
                    } else if (_sprites[22].y - actorSprite().y >= 0 &&
                               _sprites[22].y - actorSprite().y <= actorSprite().height &&
                ...
                if (actorSprite().y >= 125) {
                    if (actorSprite().x >= 197) {
                        ...
                        if (actorSprite().x > 40 && _sprites[5].status == 1 &&
                            (_spriteResourceType != 9 || actorSprite().frameIndex < 130 ||
                             actorSprite().frameIndex > 131) &&
                ...
                switch (sprite->id) {
                    ...
                    case 0x40A:
                        ...
                        if (actorSprite().anim.codeId != 0x11F0 && actorSprite().anim.codeId != 0x104A) {
                            if (sprite->x - actorSprite().x < 0 &&
                                sprite->x - actorSprite().x + sprite->width - 10 > 0) {
                                resetActor();
                            ...
                            } else if (sprite->x - actorSprite().x >= 0 &&
                                       sprite->x - actorSprite().x - actorSprite().width < 0) {
                                resetActor();
                                actorSprite().anim.codeId = 0x11F0;
                                actorSprite().anim.initialTicks = 1;
...
#define MUDCOMBI(item1, item2) ((item1 << 8) | item2)
    ...
    void EnchantiaEngine::defaultTakeItem(uint type, int16 x, int16 y, uint spriteIndex) {
        static const struct {
            uint16 animId, moveXId, animIdSmall, moveXIdSmall;
        } moveTable[] = {
